<?php
namespace EasySwoole\Oss\QiNiu\Processing;
...
final class ImageUrlBuilder
{
    ...
    public function waterImg(
        ...
        $waterStr = 'watermark/1/image/' . QiNiu\Util::base64_urlSafeEncode($image) . '/';
    ...
    public function waterText(
        ...
        $waterStr = 'watermark/2/text/'
            . QiNiu\Util::base64_urlSafeEncode($text) . '/font/'
            . Util::base64_urlSafeEncode($font) . '/';
        ...
        if (!is_null($fontColor)
            ...
            $waterStr .= 'fill/' . Util::base64_urlSafeEncode($fontColor) . '/';
        }
