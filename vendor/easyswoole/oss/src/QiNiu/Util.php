...
class Util
{
    const  QINIU_FUNCTIONS_VERSION = Config::SDK_VER;
     ...
     */
    static function crc32_file($file)
    {
     ...
     */
    static function base64_urlSafeDecode($str)
    {
        $find = array('-', '_');
        $replace = array('+', '/');
     ...
     */
    static function entry($bucket, $key)
    {
        $en = $bucket;
        if (!empty($key)) {
            $en = $bucket . ':' . $key;
     ...
     */
    static function explodeUpToken($upToken)
    {
