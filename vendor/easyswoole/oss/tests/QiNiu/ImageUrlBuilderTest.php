 ...
 * imageprocess test
 *
 * @package EasySwoole\Oss\QiNiu
 * @subpackage test
 * @author Sherlock Ren <sherlock_ren@icloud.com>
 */
class ImageUrlBuilderTest extends QiNiuBaseTestCase
{
    /**
     * 缩略图测试
     *
    ...
    {
        $imageUrlBuilder = new \EasySwoole\Oss\QiNiu\Processing\ImageUrlBuilder();
        ...
        $this->assertEquals($url, Util::thumbnail($url, 1, 0, 0));
        ...
        $this->assertEquals(
            $url . '?imageView2/1/w/200/h/200/format/png/ignore-error/1/',
            Util::thumbnail($url, 1, 200, 200, 'png')
        );
        ...
        $this->assertEquals(
            $url . '?imageView2/1/w/200/h/200/format/png/ignore-error/1/',
            Util::thumbnail($url, 1, 200, 200, 'png', 2)
        );
        ...
        $this->assertEquals(
            $url . '?imageView2/1/w/200/h/200/format/png/interlace/1/ignore-error/1/',
            Util::thumbnail($url, 1, 200, 200, 'png', 1, 101)
        );
    ...
    public function waterImgTest()
    {
        ...
        $this->assertEquals(
            $url . '?watermark/1/image/aHR0cDovL2RldmVsb3Blci5xaW5pdS5jb20vcmVzb3VyY2UvbG9nby0yLmpwZw=='
            . '/dissolve/100/gravity/SouthEast/',
            Util::waterImg($url, $image, 100, 'SouthEast', 'sad')
        );
        ...
        $this->assertEquals(
            $url . '?watermark/1/image/aHR0cDovL2RldmVsb3Blci5xaW5pdS5jb20vcmVzb3VyY2UvbG9nby0yLmpwZw=='
            . '/dissolve/100/gravity/SouthEast/',
            Util::waterImg($url, $image, 100, 'SouthEast', 'sad', 'asdf')
        );
        ...
        $this->assertEquals(
            $url . '?watermark/1/image/aHR0cDovL2RldmVsb3Blci5xaW5pdS5jb20vcmVzb3VyY2UvbG9nby0yLmpwZw=='
            . '/dissolve/100/gravity/SouthEast/',
            Util::waterImg($url, $image, 100, 'SouthEast', 'sad', 'asdf', 2)
        );
    ...
    public function waterTextTest()
    {
        ...
        $this->assertEquals(
            ...
            . 'dissolve/100/gravity/SouthEast/',
            Util::waterText($url, $text, $font, 'sdf')
        );
        ...
        $this->assertEquals(
            ...
            . '/dissolve/100/gravity/SouthEast/',
            Util::waterText($url, $text, $font, 'sdf', $fontColor)
        );
        ...
        $this->assertEquals(
            $url . '?watermark/2/text/5rWL6K-V5LiA5LiL/font/5b6u6L2v6ZuF6buR/fill/I0ZGMDAwMA=='
            . '/gravity/SouthEast/',
            Util::waterText($url, $text, $font, 'sdf', $fontColor, 101)
        );
        ...
        $this->assertEquals(
            $url . '?watermark/2/text/5rWL6K-V5LiA5LiL/font/5b6u6L2v6ZuF6buR/fill/I0ZGMDAwMA==/',
            Util::waterText($url, $text, $font, 'sdf', $fontColor, 101, 'sdfsdf')
        );
        ...
        $this->assertEquals(
            $url . '?watermark/2/text/5rWL6K-V5LiA5LiL/font/5b6u6L2v6ZuF6buR/fill/I0ZGMDAwMA==/',
            Util::waterText($url, $text, $font, 'sdf', $fontColor, 101, 'sdfsdf', 'sdfs')
        );
        ...
        $this->assertEquals(
            $url . '?watermark/2/text/5rWL6K-V5LiA5LiL/font/5b6u6L2v6ZuF6buR/fill/I0ZGMDAwMA==/',
            Util::waterText($url, $text, $font, 'sdf', $fontColor, 101, 'sdfsdf', 'sdfs', 'ssdf')
        );
        // 多参数测试
        $this->assertEquals(
        ...
        $this->assertEquals(
            $url2 . '|watermark/2/text/5rWL6K-V5LiA5LiL/font/5b6u6L2v6ZuF6buR/'
            . 'fontsize/500/dissolve/100/gravity/SouthEast/',
            Util::waterText($url2, $text, $font, 500)
        );
    }
}
