...
class BucketCnameTest extends AliYunBaseTestCase
{
    private $bucketName;
    public function setUp()
    {
        ...
        $data = $this->client->createBucket($this->bucketName);
//        $cnameConfig = $this->ossClient->createBucket($this->bucketName);
    }
    ...
    {
        $this->client->addBucketCname($this->bucketName, 'tioncicoxyz');
//        $data = $this->ossClient->addBucketCname($this->bucketName, 'www.php20.cn');
//        var_dump($data);
