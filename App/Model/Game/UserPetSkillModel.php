...
/**
 * UserPetSkillModel
 * Class UserPetSkillModel
 * Create With ClassGeneration
 * @property int $userPetSkillId // 玩家技能id
 * @property int $userId // 玩家id
 * @property int $userPetId // 玩家宠物id
 ...
 */
class UserPetSkillModel extends BaseModel
{
	protected $tableName = 'user_pet_skill_list';
