 ...
 * @ApiGroup(groupName="/Api/Common.PetSkill")
 * @ApiGroupAuth(name="")
 * @ApiGroupDescription("")
 */
class PetSkill extends CommonBase
{
	/**
	 * @Api(name="add",path="/Api/Common/PetSkill/add")
	 * @ApiDescription("新增数据")
	...
	/**
	 * @Api(name="update",path="/Api/Common/PetSkill/update")
	 * @ApiDescription("更新数据")
	 * @Method(allow={GET,POST})
	 * @InjectParamsContext(key="param")
	 * @ApiSuccessParam(name="code",description="状态码")
	...
	/**
	 * @Api(name="getOne",path="/Api/Common/PetSkill/getOne")
	...
	/**
	 * @Api(name="getList",path="/Api/Common/PetSkill/getList")
	...
	/**
	 * @Api(name="delete",path="/Api/Common/PetSkill/delete")
	 * @ApiDescription("删除数据")
	 * @Method(allow={GET,POST})
	 * @InjectParamsContext(key="param")
	 * @ApiSuccessParam(name="code",description="状态码")
