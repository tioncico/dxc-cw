 ...
 * @ApiGroup(groupName="/Api/Common/Task.UserDailyTaskPoint")
 * @ApiGroupAuth(name="")
 * @ApiGroupDescription("")
 */
class UserDailyTaskPoint extends CommonBase
{
	/**
	 * @Api(name="add",path="/Api/Common/Task/UserDailyTaskPoint/add")
	 * @ApiDescription("新增数据")
	...
	/**
	 * @Api(name="update",path="/Api/Common/Task/UserDailyTaskPoint/update")
	 * @ApiDescription("更新数据")
	 * @Method(allow={GET,POST})
	 * @InjectParamsContext(key="param")
	 * @ApiSuccessParam(name="code",description="状态码")
	...
	/**
	 * @Api(name="getOne",path="/Api/Common/Task/UserDailyTaskPoint/getOne")
	...
	/**
	 * @Api(name="getList",path="/Api/Common/Task/UserDailyTaskPoint/getList")
	...
	/**
	 * @Api(name="delete",path="/Api/Common/Task/UserDailyTaskPoint/delete")
	 * @ApiDescription("删除数据")
	 * @Method(allow={GET,POST})
	 * @InjectParamsContext(key="param")
	 * @ApiSuccessParam(name="code",description="状态码")
