 ...
 * @ApiGroup(groupName="/Api/Common/Task.UserDailyTaskReceive")
 * @ApiGroupAuth(name="")
 * @ApiGroupDescription("")
 */
class UserDailyTaskReceive extends CommonBase
{
	/**
	 * @Api(name="add",path="/Api/Common/Task/UserDailyTaskReceive/add")
	 * @ApiDescription("新增数据")
	...
	/**
	 * @Api(name="update",path="/Api/Common/Task/UserDailyTaskReceive/update")
	 * @ApiDescription("更新数据")
	 * @Method(allow={GET,POST})
	 * @InjectParamsContext(key="param")
	 * @ApiSuccessParam(name="code",description="状态码")
	...
	/**
	 * @Api(name="getOne",path="/Api/Common/Task/UserDailyTaskReceive/getOne")
	...
	/**
	 * @Api(name="getList",path="/Api/Common/Task/UserDailyTaskReceive/getList")
	...
	/**
	 * @Api(name="delete",path="/Api/Common/Task/UserDailyTaskReceive/delete")
	 * @ApiDescription("删除数据")
	 * @Method(allow={GET,POST})
	 * @InjectParamsContext(key="param")
	 * @ApiSuccessParam(name="code",description="状态码")
