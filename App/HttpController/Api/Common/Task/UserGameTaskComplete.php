 ...
 * @ApiGroup(groupName="/Api/Common/Task.UserGameTaskComplete")
 * @ApiGroupAuth(name="")
 * @ApiGroupDescription("")
 */
class UserGameTaskComplete extends CommonBase
{
	/**
	 * @Api(name="add",path="/Api/Common/Task/UserGameTaskComplete/add")
	 * @ApiDescription("新增数据")
	...
	/**
	 * @Api(name="update",path="/Api/Common/Task/UserGameTaskComplete/update")
	 * @ApiDescription("更新数据")
	 * @Method(allow={GET,POST})
	 * @InjectParamsContext(key="param")
	 * @ApiSuccessParam(name="code",description="状态码")
	...
	/**
	 * @Api(name="getOne",path="/Api/Common/Task/UserGameTaskComplete/getOne")
	...
	/**
	 * @Api(name="getList",path="/Api/Common/Task/UserGameTaskComplete/getList")
	...
	/**
	 * @Api(name="delete",path="/Api/Common/Task/UserGameTaskComplete/delete")
	 * @ApiDescription("删除数据")
	 * @Method(allow={GET,POST})
	 * @InjectParamsContext(key="param")
	 * @ApiSuccessParam(name="code",description="状态码")
