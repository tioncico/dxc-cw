 ...
 * @ApiGroup(groupName="/Api/Common/Task.GameTask")
 * @ApiGroupAuth(name="")
 * @ApiGroupDescription("")
 */
class GameTask extends CommonBase
{
	/**
	 * @Api(name="add",path="/Api/Common/Task/GameTask/add")
	 * @ApiDescription("新增数据")
	...
	/**
	 * @Api(name="update",path="/Api/Common/Task/GameTask/update")
	 * @ApiDescription("更新数据")
	 * @Method(allow={GET,POST})
	 * @InjectParamsContext(key="param")
	 * @ApiSuccessParam(name="code",description="状态码")
	...
	/**
	 * @Api(name="getOne",path="/Api/Common/Task/GameTask/getOne")
	...
	/**
	 * @Api(name="getList",path="/Api/Common/Task/GameTask/getList")
	...
	/**
	 * @Api(name="delete",path="/Api/Common/Task/GameTask/delete")
	 * @ApiDescription("删除数据")
	 * @Method(allow={GET,POST})
	 * @InjectParamsContext(key="param")
	 * @ApiSuccessParam(name="code",description="状态码")
