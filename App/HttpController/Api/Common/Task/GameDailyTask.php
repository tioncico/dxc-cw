 ...
 * @ApiGroup(groupName="/Api/Common/Task.GameDailyTask")
 * @ApiGroupAuth(name="")
 * @ApiGroupDescription("")
 */
class GameDailyTask extends CommonBase
{
	/**
	 * @Api(name="add",path="/Api/Common/Task/GameDailyTask/add")
	 * @ApiDescription("新增数据")
	...
	/**
	 * @Api(name="update",path="/Api/Common/Task/GameDailyTask/update")
	 * @ApiDescription("更新数据")
	 * @Method(allow={GET,POST})
	 * @InjectParamsContext(key="param")
	 * @ApiSuccessParam(name="code",description="状态码")
	...
	/**
	 * @Api(name="getOne",path="/Api/Common/Task/GameDailyTask/getOne")
	...
	/**
	 * @Api(name="getList",path="/Api/Common/Task/GameDailyTask/getList")
	...
	/**
	 * @Api(name="delete",path="/Api/Common/Task/GameDailyTask/delete")
	 * @ApiDescription("删除数据")
	 * @Method(allow={GET,POST})
	 * @InjectParamsContext(key="param")
	 * @ApiSuccessParam(name="code",description="状态码")
