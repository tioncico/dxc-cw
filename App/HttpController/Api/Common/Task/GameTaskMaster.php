 ...
 * @ApiGroup(groupName="/Api/Common/Task.GameTaskMaster")
 * @ApiGroupAuth(name="")
 * @ApiGroupDescription("")
 */
class GameTaskMaster extends CommonBase
{
	/**
	 * @Api(name="add",path="/Api/Common/Task/GameTaskMaster/add")
	 * @ApiDescription("新增数据")
	...
	/**
	 * @Api(name="update",path="/Api/Common/Task/GameTaskMaster/update")
	 * @ApiDescription("更新数据")
	 * @Method(allow={GET,POST})
	 * @InjectParamsContext(key="param")
	 * @ApiSuccessParam(name="code",description="状态码")
	...
	/**
	 * @Api(name="getOne",path="/Api/Common/Task/GameTaskMaster/getOne")
	...
	/**
	 * @Api(name="getList",path="/Api/Common/Task/GameTaskMaster/getList")
	...
	/**
	 * @Api(name="delete",path="/Api/Common/Task/GameTaskMaster/delete")
	 * @ApiDescription("删除数据")
	 * @Method(allow={GET,POST})
	 * @InjectParamsContext(key="param")
	 * @ApiSuccessParam(name="code",description="状态码")
