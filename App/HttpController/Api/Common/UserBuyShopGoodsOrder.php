 ...
 * @ApiGroup(groupName="/Api/Common.UserBuyShopGoodsOrder")
 * @ApiGroupAuth(name="")
 * @ApiGroupDescription("")
 */
class UserBuyShopGoodsOrder extends CommonBase
{
	/**
	 * @Api(name="add",path="/Api/Common/UserBuyShopGoodsOrder/add")
	 * @ApiDescription("新增数据")
	...
	/**
	 * @Api(name="update",path="/Api/Common/UserBuyShopGoodsOrder/update")
	 * @ApiDescription("更新数据")
	 * @Method(allow={GET,POST})
	 * @InjectParamsContext(key="param")
	 * @ApiSuccessParam(name="code",description="状态码")
	...
	/**
	 * @Api(name="getOne",path="/Api/Common/UserBuyShopGoodsOrder/getOne")
	...
	/**
	 * @Api(name="getList",path="/Api/Common/UserBuyShopGoodsOrder/getList")
	...
	/**
	 * @Api(name="delete",path="/Api/Common/UserBuyShopGoodsOrder/delete")
	 * @ApiDescription("删除数据")
	 * @Method(allow={GET,POST})
	 * @InjectParamsContext(key="param")
	 * @ApiSuccessParam(name="code",description="状态码")
