 ...
 * @ApiGroup(groupName="/Api/Common.GoodsEquipment")
 * @ApiGroupAuth(name="")
 * @ApiGroupDescription("")
 */
class GoodsEquipment extends CommonBase
{
	/**
	 * @Api(name="add",path="/Api/Common/GoodsEquipment/add")
	 * @ApiDescription("新增数据")
	...
	/**
	 * @Api(name="update",path="/Api/Common/GoodsEquipment/update")
	 * @ApiDescription("更新数据")
	 * @Method(allow={GET,POST})
	 * @InjectParamsContext(key="param")
	 * @ApiSuccessParam(name="code",description="状态码")
	...
	/**
	 * @Api(name="getOne",path="/Api/Common/GoodsEquipment/getOne")
	...
	/**
	 * @Api(name="getList",path="/Api/Common/GoodsEquipment/getList")
	...
	/**
	 * @Api(name="delete",path="/Api/Common/GoodsEquipment/delete")
	 * @ApiDescription("删除数据")
	 * @Method(allow={GET,POST})
	 * @InjectParamsContext(key="param")
	 * @ApiSuccessParam(name="code",description="状态码")
