 ...
 * @ApiGroup(groupName="/Api/Common.Skill")
 * @ApiGroupAuth(name="")
 * @ApiGroupDescription("")
 */
class Skill extends CommonBase
{
	/**
	 * @Api(name="add",path="/Api/Common/Skill/add")
	 * @ApiDescription("新增数据")
	...
	/**
	 * @Api(name="update",path="/Api/Common/Skill/update")
	 * @ApiDescription("更新数据")
	 * @Method(allow={GET,POST})
	 * @InjectParamsContext(key="param")
	 * @ApiSuccessParam(name="code",description="状态码")
	...
	/**
	 * @Api(name="getOne",path="/Api/Common/Skill/getOne")
	...
	/**
	 * @Api(name="getList",path="/Api/Common/Skill/getList")
	...
	/**
	 * @Api(name="delete",path="/Api/Common/Skill/delete")
	 * @ApiDescription("删除数据")
	 * @Method(allow={GET,POST})
	 * @InjectParamsContext(key="param")
	 * @ApiSuccessParam(name="code",description="状态码")
