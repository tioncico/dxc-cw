 ...
 * @ApiGroup(groupName="/Api/Common.UserExtraLimit")
 * @ApiGroupAuth(name="")
 * @ApiGroupDescription("")
 */
class UserExtraLimit extends CommonBase
{
	/**
	 * @Api(name="add",path="/Api/Common/UserExtraLimit/add")
	 * @ApiDescription("新增数据")
	...
	/**
	 * @Api(name="update",path="/Api/Common/UserExtraLimit/update")
	 * @ApiDescription("更新数据")
	 * @Method(allow={GET,POST})
	 * @InjectParamsContext(key="param")
	 * @ApiSuccessParam(name="code",description="状态码")
	...
	/**
	 * @Api(name="getOne",path="/Api/Common/UserExtraLimit/getOne")
	...
	/**
	 * @Api(name="getList",path="/Api/Common/UserExtraLimit/getList")
	...
	/**
	 * @Api(name="delete",path="/Api/Common/UserExtraLimit/delete")
	 * @ApiDescription("删除数据")
	 * @Method(allow={GET,POST})
	 * @InjectParamsContext(key="param")
	 * @ApiSuccessParam(name="code",description="状态码")
