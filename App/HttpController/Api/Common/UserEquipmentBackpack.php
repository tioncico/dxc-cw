 ...
 * @ApiGroup(groupName="/Api/Common.UserEquipmentBackpack")
 * @ApiGroupAuth(name="")
 * @ApiGroupDescription("")
 */
class UserEquipmentBackpack extends CommonBase
{
	/**
	 * @Api(name="add",path="/Api/Common/UserEquipmentBackpack/add")
	 * @ApiDescription("新增数据")
	...
	/**
	 * @Api(name="update",path="/Api/Common/UserEquipmentBackpack/update")
	 * @ApiDescription("更新数据")
	 * @Method(allow={GET,POST})
	 * @InjectParamsContext(key="param")
	 * @ApiSuccessParam(name="code",description="状态码")
	...
	/**
	 * @Api(name="getOne",path="/Api/Common/UserEquipmentBackpack/getOne")
	...
	/**
	 * @Api(name="getList",path="/Api/Common/UserEquipmentBackpack/getList")
	...
	/**
	 * @Api(name="delete",path="/Api/Common/UserEquipmentBackpack/delete")
	 * @ApiDescription("删除数据")
	 * @Method(allow={GET,POST})
	 * @InjectParamsContext(key="param")
	 * @ApiSuccessParam(name="code",description="状态码")
