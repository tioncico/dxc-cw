 ...
 * @ApiGroup(groupName="/Api/Common.UserPetSkill")
 * @ApiGroupAuth(name="")
 * @ApiGroupDescription("")
 */
class UserPetSkill extends CommonBase
{
	/**
	 * @Api(name="add",path="/Api/Common/UserPetSkill/add")
	 * @ApiDescription("新增数据")
	 ...
	 * @Param(name="userPetId",alias="玩家宠物id",description="玩家宠物id",lengthMax="11",optional="")
	...
	public function add()
	{
		...
		$model = new UserPetSkillModel($data);
		$model->save();
	...
	/**
	 * @Api(name="update",path="/Api/Common/UserPetSkill/update")
	 * @ApiDescription("更新数据")
	 * @Method(allow={GET,POST})
	 * @InjectParamsContext(key="param")
	 * @ApiSuccessParam(name="code",description="状态码")
	 ...
	 * @Param(name="userPetSkillId",alias="玩家技能id",description="玩家技能id",lengthMax="11",required="")
	 * @Param(name="userId",alias="玩家id",description="玩家id",lengthMax="11",optional="")
	 * @Param(name="userPetId",alias="玩家宠物id",description="玩家宠物id",lengthMax="11",optional="")
	 * @Param(name="skillId",alias="技能id",description="技能id",lengthMax="11",optional="")
	 * @Param(name="skillName",alias="技能名",description="技能名",lengthMax="255",optional="")
	...
	{
		$param = ContextManager::getInstance()->get('param');
		$model = new UserPetSkillModel();
		$info = $model->get(['userPetSkillId' => $param['userPetSkillId']]);
		if (empty($info)) {
		...
		$updateData['userPetId']=$param['userPetId'] ?? $info->userPetId;
	...
	/**
	 * @Api(name="getOne",path="/Api/Common/UserPetSkill/getOne")
	 ...
	 * @Param(name="userPetSkillId",alias="玩家技能id",description="玩家技能id",lengthMax="11",required="")
	 * @ApiSuccessParam(name="result.userPetSkillId",description="玩家技能id")
	 * @ApiSuccessParam(name="result.userId",description="玩家id")
	 * @ApiSuccessParam(name="result.userPetId",description="玩家宠物id")
	...
	/**
	 * @Api(name="getList",path="/Api/Common/UserPetSkill/getList")
	...
	/**
	 * @Api(name="delete",path="/Api/Common/UserPetSkill/delete")
	 * @ApiDescription("删除数据")
	 * @Method(allow={GET,POST})
	 * @InjectParamsContext(key="param")
	 * @ApiSuccessParam(name="code",description="状态码")
