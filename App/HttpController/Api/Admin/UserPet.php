 ...
 * @ApiGroup(groupName="/Api/Admin.UserPet")
 * @ApiGroupAuth(name="")
 * @ApiGroupDescription("")
 */
class UserPet extends AdminBase
{
	/**
	 * @Api(name="add",path="/Api/Admin/UserPet/add")
	 * @ApiDescription("新增数据")
	...
	/**
	 * @Api(name="update",path="/Api/Admin/UserPet/update")
	 * @ApiDescription("更新数据")
	 * @Method(allow={GET,POST})
	 * @InjectParamsContext(key="param")
	 * @ApiSuccessParam(name="code",description="状态码")
	...
	/**
	 * @Api(name="getOne",path="/Api/Admin/UserPet/getOne")
	...
	/**
	 * @Api(name="getList",path="/Api/Admin/UserPet/getList")
	...
	/**
	 * @Api(name="delete",path="/Api/Admin/UserPet/delete")
	 * @ApiDescription("删除数据")
	 * @Method(allow={GET,POST})
	 * @InjectParamsContext(key="param")
	 * @ApiSuccessParam(name="code",description="状态码")
