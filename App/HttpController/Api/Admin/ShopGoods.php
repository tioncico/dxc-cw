 ...
 * @ApiGroup(groupName="/Api/Admin.ShopGoods")
 * @ApiGroupAuth(name="")
 * @ApiGroupDescription("")
 */
...
{
	/**
	 * @Api(name="add",path="/Api/Admin/ShopGoods/add")
	 * @ApiDescription("新增数据")
	...
	/**
	 * @Api(name="update",path="/Api/Admin/ShopGoods/update")
	 * @ApiDescription("更新数据")
	 * @Method(allow={GET,POST})
	 * @InjectParamsContext(key="param")
	 * @ApiSuccessParam(name="code",description="状态码")
	...
	/**
	 * @Api(name="getOne",path="/Api/Admin/ShopGoods/getOne")
	...
	/**
	 * @Api(name="获取商店列表",path="/Api/Admin/ShopGoods/getList")
	...
	/**
	 * @Api(name="delete",path="/Api/Admin/ShopGoods/delete")
	 * @ApiDescription("删除数据")
	 * @Method(allow={GET,POST})
	 * @InjectParamsContext(key="param")
	 * @ApiSuccessParam(name="code",description="状态码")
