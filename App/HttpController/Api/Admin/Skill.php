 ...
 * @ApiGroup(groupName="/Api/Admin.Skill")
 * @ApiGroupAuth(name="")
 * @ApiGroupDescription("")
 */
class Skill extends AdminBase
{
	/**
	 * @Api(name="add",path="/Api/Admin/Skill/add")
	 * @ApiDescription("新增数据")
	...
	/**
	 * @Api(name="update",path="/Api/Admin/Skill/update")
	 * @ApiDescription("更新数据")
	 * @Method(allow={GET,POST})
	 * @InjectParamsContext(key="param")
	 * @ApiSuccessParam(name="code",description="状态码")
	...
	/**
	 * @Api(name="getOne",path="/Api/Admin/Skill/getOne")
	...
	/**
	 * @Api(name="getList",path="/Api/Admin/Skill/getList")
	...
	/**
	 * @Api(name="delete",path="/Api/Admin/Skill/delete")
	 * @ApiDescription("删除数据")
	 * @Method(allow={GET,POST})
	 * @InjectParamsContext(key="param")
	 * @ApiSuccessParam(name="code",description="状态码")
