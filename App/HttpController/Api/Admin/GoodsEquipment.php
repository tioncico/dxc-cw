 ...
 * @ApiGroup(groupName="/Api/Admin.GoodsEquipment")
 * @ApiGroupAuth(name="")
 * @ApiGroupDescription("")
 */
class GoodsEquipment extends AdminBase
{
	/**
	 * @Api(name="add",path="/Api/Admin/GoodsEquipment/add")
	 * @ApiDescription("新增数据")
	 ...
	 * @Param(name="description",alias="装备介绍",description="装备介绍",lengthMax="255",optional="")
	...
	/**
	 * @Api(name="update",path="/Api/Admin/GoodsEquipment/update")
	 * @ApiDescription("更新数据")
	 * @Method(allow={GET,POST})
	 * @InjectParamsContext(key="param")
	 * @ApiSuccessParam(name="code",description="状态码")
	...
	/**
	 * @Api(name="getOne",path="/Api/Admin/GoodsEquipment/getOne")
	 ...
	 * @ApiSuccessParam(name="result.description",description="装备介绍")
	...
	/**
	 * @Api(name="getList",path="/Api/Admin/GoodsEquipment/getList")
	...
	/**
	 * @Api(name="delete",path="/Api/Admin/GoodsEquipment/delete")
	 * @ApiDescription("删除数据")
	 * @Method(allow={GET,POST})
	 * @InjectParamsContext(key="param")
	 * @ApiSuccessParam(name="code",description="状态码")
