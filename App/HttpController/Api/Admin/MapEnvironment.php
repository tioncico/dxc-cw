 ...
 * @ApiGroup(groupName="/Api/Admin.MapEnvironment")
 * @ApiGroupAuth(name="")
 * @ApiGroupDescription("")
 */
class MapEnvironment extends AdminBase
{
	/**
	 * @Api(name="add",path="/Api/Admin/MapEnvironment/add")
	 * @ApiDescription("新增数据")
	...
	/**
	 * @Api(name="update",path="/Api/Admin/MapEnvironment/update")
	 * @ApiDescription("更新数据")
	 * @Method(allow={GET,POST})
	 * @InjectParamsContext(key="param")
	 * @ApiSuccessParam(name="code",description="状态码")
	...
	/**
	 * @Api(name="getOne",path="/Api/Admin/MapEnvironment/getOne")
	...
	/**
	 * @Api(name="getList",path="/Api/Admin/MapEnvironment/getList")
	...
	/**
	 * @Api(name="delete",path="/Api/Admin/MapEnvironment/delete")
	 * @ApiDescription("删除数据")
	 * @Method(allow={GET,POST})
	 * @InjectParamsContext(key="param")
	 * @ApiSuccessParam(name="code",description="状态码")
