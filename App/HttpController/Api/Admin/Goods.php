 ...
 * @ApiGroup(groupName="/Api/Admin.Goods")
 * @ApiGroupAuth(name="")
 * @ApiGroupDescription("")
 */
...
{
	/**
	 * @Api(name="add",path="/Api/Admin/Goods/add")
	 * @ApiDescription("新增数据")
	...
	/**
	 * @Api(name="update",path="/Api/Admin/Goods/update")
	 * @ApiDescription("更新数据")
	 * @Method(allow={GET,POST})
	 * @InjectParamsContext(key="param")
	 * @ApiSuccessParam(name="code",description="状态码")
	...
	/**
	 * @Api(name="getOne",path="/Api/Admin/Goods/getOne")
	...
	/**
	 * @Api(name="getList",path="/Api/Admin/Goods/getList")
	...
	/**
	 * @Api(name="delete",path="/Api/Admin/Goods/delete")
	 * @ApiDescription("删除数据")
	 * @Method(allow={GET,POST})
	 * @InjectParamsContext(key="param")
	 * @ApiSuccessParam(name="code",description="状态码")
