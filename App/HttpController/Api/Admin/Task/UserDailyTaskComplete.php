 ...
 * @ApiGroup(groupName="/Api/Admin/Task.UserDailyTaskComplete")
 * @ApiGroupAuth(name="")
 * @ApiGroupDescription("")
 */
class UserDailyTaskComplete extends AdminBase
{
	/**
	 * @Api(name="add",path="/Api/Admin/Task/UserDailyTaskComplete/add")
	 * @ApiDescription("新增数据")
	...
	/**
	 * @Api(name="update",path="/Api/Admin/Task/UserDailyTaskComplete/update")
	 * @ApiDescription("更新数据")
	 * @Method(allow={GET,POST})
	 * @InjectParamsContext(key="param")
	 * @ApiSuccessParam(name="code",description="状态码")
	...
	/**
	 * @Api(name="getOne",path="/Api/Admin/Task/UserDailyTaskComplete/getOne")
	...
	/**
	 * @Api(name="getList",path="/Api/Admin/Task/UserDailyTaskComplete/getList")
	...
	/**
	 * @Api(name="delete",path="/Api/Admin/Task/UserDailyTaskComplete/delete")
	 * @ApiDescription("删除数据")
	 * @Method(allow={GET,POST})
	 * @InjectParamsContext(key="param")
	 * @ApiSuccessParam(name="code",description="状态码")
