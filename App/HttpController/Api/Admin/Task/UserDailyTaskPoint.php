 ...
 * @ApiGroup(groupName="/Api/Admin/Task.UserDailyTaskPoint")
 * @ApiGroupAuth(name="")
 * @ApiGroupDescription("")
 */
class UserDailyTaskPoint extends AdminBase
{
	/**
	 * @Api(name="add",path="/Api/Admin/Task/UserDailyTaskPoint/add")
	 * @ApiDescription("新增数据")
	...
	/**
	 * @Api(name="update",path="/Api/Admin/Task/UserDailyTaskPoint/update")
	 * @ApiDescription("更新数据")
	 * @Method(allow={GET,POST})
	 * @InjectParamsContext(key="param")
	 * @ApiSuccessParam(name="code",description="状态码")
	...
	/**
	 * @Api(name="getOne",path="/Api/Admin/Task/UserDailyTaskPoint/getOne")
	...
	/**
	 * @Api(name="getList",path="/Api/Admin/Task/UserDailyTaskPoint/getList")
	...
	/**
	 * @Api(name="delete",path="/Api/Admin/Task/UserDailyTaskPoint/delete")
	 * @ApiDescription("删除数据")
	 * @Method(allow={GET,POST})
	 * @InjectParamsContext(key="param")
	 * @ApiSuccessParam(name="code",description="状态码")
