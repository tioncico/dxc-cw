 ...
 * @ApiGroup(groupName="/Api/Admin/Task.GameDailyTaskPointReward")
 * @ApiGroupAuth(name="")
 * @ApiGroupDescription("")
 */
class GameDailyTaskPointReward extends AdminBase
{
	/**
	 * @Api(name="add",path="/Api/Admin/Task/GameDailyTaskPointReward/add")
	 * @ApiDescription("新增数据")
	...
	/**
	 * @Api(name="update",path="/Api/Admin/Task/GameDailyTaskPointReward/update")
	 * @ApiDescription("更新数据")
	 * @Method(allow={GET,POST})
	 * @InjectParamsContext(key="param")
	 * @ApiSuccessParam(name="code",description="状态码")
	...
	/**
	 * @Api(name="getOne",path="/Api/Admin/Task/GameDailyTaskPointReward/getOne")
	...
	/**
	 * @Api(name="getList",path="/Api/Admin/Task/GameDailyTaskPointReward/getList")
	...
	/**
	 * @Api(name="delete",path="/Api/Admin/Task/GameDailyTaskPointReward/delete")
	 * @ApiDescription("删除数据")
	 * @Method(allow={GET,POST})
	 * @InjectParamsContext(key="param")
	 * @ApiSuccessParam(name="code",description="状态码")
