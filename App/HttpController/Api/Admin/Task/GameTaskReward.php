 ...
 * @ApiGroup(groupName="/Api/Admin/Task.GameTaskReward")
 * @ApiGroupAuth(name="")
 * @ApiGroupDescription("")
 */
class GameTaskReward extends AdminBase
{
	/**
	 * @Api(name="add",path="/Api/Admin/Task/GameTaskReward/add")
	 * @ApiDescription("新增数据")
	...
	/**
	 * @Api(name="update",path="/Api/Admin/Task/GameTaskReward/update")
	 * @ApiDescription("更新数据")
	 * @Method(allow={GET,POST})
	 * @InjectParamsContext(key="param")
	 * @ApiSuccessParam(name="code",description="状态码")
	...
	/**
	 * @Api(name="getOne",path="/Api/Admin/Task/GameTaskReward/getOne")
	...
	/**
	 * @Api(name="getList",path="/Api/Admin/Task/GameTaskReward/getList")
	...
	/**
	 * @Api(name="delete",path="/Api/Admin/Task/GameTaskReward/delete")
	 * @ApiDescription("删除数据")
	 * @Method(allow={GET,POST})
	 * @InjectParamsContext(key="param")
	 * @ApiSuccessParam(name="code",description="状态码")
