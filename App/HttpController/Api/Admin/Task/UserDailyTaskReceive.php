 ...
 * @ApiGroup(groupName="/Api/Admin/Task.UserDailyTaskReceive")
 * @ApiGroupAuth(name="")
 * @ApiGroupDescription("")
 */
class UserDailyTaskReceive extends AdminBase
{
	/**
	 * @Api(name="add",path="/Api/Admin/Task/UserDailyTaskReceive/add")
	 * @ApiDescription("新增数据")
	...
	/**
	 * @Api(name="update",path="/Api/Admin/Task/UserDailyTaskReceive/update")
	 * @ApiDescription("更新数据")
	 * @Method(allow={GET,POST})
	 * @InjectParamsContext(key="param")
	 * @ApiSuccessParam(name="code",description="状态码")
	...
	/**
	 * @Api(name="getOne",path="/Api/Admin/Task/UserDailyTaskReceive/getOne")
	...
	/**
	 * @Api(name="getList",path="/Api/Admin/Task/UserDailyTaskReceive/getList")
	...
	/**
	 * @Api(name="delete",path="/Api/Admin/Task/UserDailyTaskReceive/delete")
	 * @ApiDescription("删除数据")
	 * @Method(allow={GET,POST})
	 * @InjectParamsContext(key="param")
	 * @ApiSuccessParam(name="code",description="状态码")
