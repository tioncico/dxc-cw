 ...
 * @ApiGroup(groupName="/Api/Admin/Task.UserGameTaskMasterComplete")
 * @ApiGroupAuth(name="")
 * @ApiGroupDescription("")
 */
class UserGameTaskMasterComplete extends AdminBase
{
	/**
	 * @Api(name="add",path="/Api/Admin/Task/UserGameTaskMasterComplete/add")
	 * @ApiDescription("新增数据")
	...
	/**
	 * @Api(name="update",path="/Api/Admin/Task/UserGameTaskMasterComplete/update")
	 * @ApiDescription("更新数据")
	 * @Method(allow={GET,POST})
	 * @InjectParamsContext(key="param")
	 * @ApiSuccessParam(name="code",description="状态码")
	...
	/**
	 * @Api(name="getOne",path="/Api/Admin/Task/UserGameTaskMasterComplete/getOne")
	...
	/**
	 * @Api(name="getList",path="/Api/Admin/Task/UserGameTaskMasterComplete/getList")
	...
	/**
	 * @Api(name="delete",path="/Api/Admin/Task/UserGameTaskMasterComplete/delete")
	 * @ApiDescription("删除数据")
	 * @Method(allow={GET,POST})
	 * @InjectParamsContext(key="param")
	 * @ApiSuccessParam(name="code",description="状态码")
