 ...
 * @ApiGroup(groupName="/Api/Admin/Task.GameTaskMaster")
 * @ApiGroupAuth(name="")
 * @ApiGroupDescription("")
 */
class GameTaskMaster extends AdminBase
{
	/**
	 * @Api(name="add",path="/Api/Admin/Task/GameTaskMaster/add")
	 * @ApiDescription("新增数据")
	...
	/**
	 * @Api(name="update",path="/Api/Admin/Task/GameTaskMaster/update")
	 * @ApiDescription("更新数据")
	 * @Method(allow={GET,POST})
	 * @InjectParamsContext(key="param")
	 * @ApiSuccessParam(name="code",description="状态码")
	...
	/**
	 * @Api(name="getOne",path="/Api/Admin/Task/GameTaskMaster/getOne")
	...
	/**
	 * @Api(name="getList",path="/Api/Admin/Task/GameTaskMaster/getList")
	...
	/**
	 * @Api(name="delete",path="/Api/Admin/Task/GameTaskMaster/delete")
	 * @ApiDescription("删除数据")
	 * @Method(allow={GET,POST})
	 * @InjectParamsContext(key="param")
	 * @ApiSuccessParam(name="code",description="状态码")
