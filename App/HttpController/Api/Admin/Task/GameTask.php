 ...
 * @ApiGroup(groupName="/Api/Admin/Task.GameTask")
 * @ApiGroupAuth(name="")
 * @ApiGroupDescription("")
 */
class GameTask extends AdminBase
{
	/**
	 * @Api(name="add",path="/Api/Admin/Task/GameTask/add")
	 * @ApiDescription("新增数据")
	...
	/**
	 * @Api(name="update",path="/Api/Admin/Task/GameTask/update")
	 * @ApiDescription("更新数据")
	 * @Method(allow={GET,POST})
	 * @InjectParamsContext(key="param")
	 * @ApiSuccessParam(name="code",description="状态码")
	...
	/**
	 * @Api(name="getOne",path="/Api/Admin/Task/GameTask/getOne")
	...
	/**
	 * @Api(name="getList",path="/Api/Admin/Task/GameTask/getList")
	...
	/**
	 * @Api(name="delete",path="/Api/Admin/Task/GameTask/delete")
	 * @ApiDescription("删除数据")
	 * @Method(allow={GET,POST})
	 * @InjectParamsContext(key="param")
	 * @ApiSuccessParam(name="code",description="状态码")
