 ...
 * @ApiGroup(groupName="/Api/Admin.AttributeEntry")
 * @ApiGroupAuth(name="")
 * @ApiGroupDescription("")
 */
class AttributeEntry extends AdminBase
{
	/**
	 * @Api(name="add",path="/Api/Admin/AttributeEntry/add")
	 * @ApiDescription("新增数据")
	...
	/**
	 * @Api(name="update",path="/Api/Admin/AttributeEntry/update")
	 * @ApiDescription("更新数据")
	 * @Method(allow={GET,POST})
	 * @InjectParamsContext(key="param")
	 * @ApiSuccessParam(name="code",description="状态码")
	...
	/**
	 * @Api(name="getOne",path="/Api/Admin/AttributeEntry/getOne")
	...
	/**
	 * @Api(name="getList",path="/Api/Admin/AttributeEntry/getList")
	...
	/**
	 * @Api(name="delete",path="/Api/Admin/AttributeEntry/delete")
	 * @ApiDescription("删除数据")
	 * @Method(allow={GET,POST})
	 * @InjectParamsContext(key="param")
	 * @ApiSuccessParam(name="code",description="状态码")
