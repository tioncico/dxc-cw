 ...
 * @ApiGroup(groupName="/Api/Admin.MailGoods")
 * @ApiGroupAuth(name="")
 * @ApiGroupDescription("")
 */
class MailGoods extends AdminBase
{
	/**
	 * @Api(name="add",path="/Api/Admin/MailGoods/add")
	 * @ApiDescription("新增数据")
	...
	/**
	 * @Api(name="update",path="/Api/Admin/MailGoods/update")
	 * @ApiDescription("更新数据")
	 * @Method(allow={GET,POST})
	 * @InjectParamsContext(key="param")
	 * @ApiSuccessParam(name="code",description="状态码")
	...
	/**
	 * @Api(name="getOne",path="/Api/Admin/MailGoods/getOne")
	...
	/**
	 * @Api(name="getList",path="/Api/Admin/MailGoods/getList")
	...
	/**
	 * @Api(name="delete",path="/Api/Admin/MailGoods/delete")
	 * @ApiDescription("删除数据")
	 * @Method(allow={GET,POST})
	 * @InjectParamsContext(key="param")
	 * @ApiSuccessParam(name="code",description="状态码")
