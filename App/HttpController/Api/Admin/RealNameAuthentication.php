 ...
 * @ApiGroup(groupName="/Api/Admin.RealNameAuthentication")
 * @ApiGroupAuth(name="")
 * @ApiGroupDescription("")
 */
class RealNameAuthentication extends AdminBase
{
	/**
	 * @Api(name="add",path="/Api/Admin/RealNameAuthentication/add")
	 * @ApiDescription("新增数据")
	...
	/**
	 * @Api(name="update",path="/Api/Admin/RealNameAuthentication/update")
	 * @ApiDescription("更新数据")
	 * @Method(allow={GET,POST})
	 * @InjectParamsContext(key="param")
	 * @ApiSuccessParam(name="code",description="状态码")
	...
	/**
	 * @Api(name="getOne",path="/Api/Admin/RealNameAuthentication/getOne")
	...
	/**
	 * @Api(name="getList",path="/Api/Admin/RealNameAuthentication/getList")
	...
	/**
	 * @Api(name="delete",path="/Api/Admin/RealNameAuthentication/delete")
	 * @ApiDescription("删除数据")
	 * @Method(allow={GET,POST})
	 * @InjectParamsContext(key="param")
	 * @ApiSuccessParam(name="code",description="状态码")
