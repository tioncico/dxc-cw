 ...
 * @ApiGroup(groupName="/Api/Admin.UserGoodsEquipmentAttributeEntry")
 * @ApiGroupAuth(name="")
 * @ApiGroupDescription("")
 */
class UserGoodsEquipmentAttributeEntry extends AdminBase
{
	/**
	 * @Api(name="add",path="/Api/Admin/UserGoodsEquipmentAttributeEntry/add")
	 * @ApiDescription("新增数据")
	...
	/**
	 * @Api(name="update",path="/Api/Admin/UserGoodsEquipmentAttributeEntry/update")
	 * @ApiDescription("更新数据")
	 * @Method(allow={GET,POST})
	 * @InjectParamsContext(key="param")
	 * @ApiSuccessParam(name="code",description="状态码")
	...
	/**
	 * @Api(name="getOne",path="/Api/Admin/UserGoodsEquipmentAttributeEntry/getOne")
	...
	/**
	 * @Api(name="getList",path="/Api/Admin/UserGoodsEquipmentAttributeEntry/getList")
	...
	/**
	 * @Api(name="delete",path="/Api/Admin/UserGoodsEquipmentAttributeEntry/delete")
	 * @ApiDescription("删除数据")
	 * @Method(allow={GET,POST})
	 * @InjectParamsContext(key="param")
	 * @ApiSuccessParam(name="code",description="状态码")
