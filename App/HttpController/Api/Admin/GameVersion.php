 ...
 * @ApiGroup(groupName="/Api/Admin.GameVersion")
 * @ApiGroupAuth(name="")
 * @ApiGroupDescription("")
 */
class GameVersion extends AdminBase
{
	/**
	 * @Api(name="add",path="/Api/Admin/GameVersion/add")
	 * @ApiDescription("新增数据")
	...
	/**
	 * @Api(name="update",path="/Api/Admin/GameVersion/update")
	 * @ApiDescription("更新数据")
	 * @Method(allow={GET,POST})
	 * @InjectParamsContext(key="param")
	 * @ApiSuccessParam(name="code",description="状态码")
	...
	/**
	 * @Api(name="getOne",path="/Api/Admin/GameVersion/getOne")
	...
	/**
	 * @Api(name="getList",path="/Api/Admin/GameVersion/getList")
	...
	/**
	 * @Api(name="delete",path="/Api/Admin/GameVersion/delete")
	 * @ApiDescription("删除数据")
	 * @Method(allow={GET,POST})
	 * @InjectParamsContext(key="param")
	 * @ApiSuccessParam(name="code",description="状态码")
