 ...
 * @ApiGroup(groupName="/Api/Admin.UserPetSkill")
 * @ApiGroupAuth(name="")
 * @ApiGroupDescription("")
 */
class UserPetSkill extends AdminBase
{
	/**
	 * @Api(name="add",path="/Api/Admin/UserPetSkill/add")
	 * @ApiDescription("新增数据")
	...
	/**
	 * @Api(name="update",path="/Api/Admin/UserPetSkill/update")
	 * @ApiDescription("更新数据")
	 * @Method(allow={GET,POST})
	 * @InjectParamsContext(key="param")
	 * @ApiSuccessParam(name="code",description="状态码")
	...
	/**
	 * @Api(name="getOne",path="/Api/Admin/UserPetSkill/getOne")
	...
	/**
	 * @Api(name="getList",path="/Api/Admin/UserPetSkill/getList")
	...
	/**
	 * @Api(name="delete",path="/Api/Admin/UserPetSkill/delete")
	 * @ApiDescription("删除数据")
	 * @Method(allow={GET,POST})
	 * @InjectParamsContext(key="param")
	 * @ApiSuccessParam(name="code",description="状态码")
