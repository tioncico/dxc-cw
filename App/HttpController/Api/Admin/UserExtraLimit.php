 ...
 * @ApiGroup(groupName="/Api/Admin.UserExtraLimit")
 * @ApiGroupAuth(name="")
 * @ApiGroupDescription("")
 */
class UserExtraLimit extends AdminBase
{
	/**
	 * @Api(name="add",path="/Api/Admin/UserExtraLimit/add")
	 * @ApiDescription("新增数据")
	...
	/**
	 * @Api(name="update",path="/Api/Admin/UserExtraLimit/update")
	 * @ApiDescription("更新数据")
	 * @Method(allow={GET,POST})
	 * @InjectParamsContext(key="param")
	 * @ApiSuccessParam(name="code",description="状态码")
	...
	/**
	 * @Api(name="getOne",path="/Api/Admin/UserExtraLimit/getOne")
	...
	/**
	 * @Api(name="getList",path="/Api/Admin/UserExtraLimit/getList")
	...
	/**
	 * @Api(name="delete",path="/Api/Admin/UserExtraLimit/delete")
	 * @ApiDescription("删除数据")
	 * @Method(allow={GET,POST})
	 * @InjectParamsContext(key="param")
	 * @ApiSuccessParam(name="code",description="状态码")
