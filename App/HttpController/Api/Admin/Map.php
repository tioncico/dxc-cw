 ...
 * @ApiGroup(groupName="/Api/Admin.Map")
 * @ApiGroupAuth(name="")
 * @ApiGroupDescription("")
 */
...
{
	/**
	 * @Api(name="add",path="/Api/Admin/Map/add")
	 * @ApiDescription("新增数据")
	...
	/**
	 * @Api(name="update",path="/Api/Admin/Map/update")
	 * @ApiDescription("更新数据")
	 * @Method(allow={GET,POST})
	 * @InjectParamsContext(key="param")
	 * @ApiSuccessParam(name="code",description="状态码")
	...
	/**
	 * @Api(name="getOne",path="/Api/Admin/Map/getOne")
	...
	/**
	 * @Api(name="getList",path="/Api/Admin/Map/getList")
	...
	/**
	 * @Api(name="delete",path="/Api/Admin/Map/delete")
	 * @ApiDescription("删除数据")
	 * @Method(allow={GET,POST})
	 * @InjectParamsContext(key="param")
	 * @ApiSuccessParam(name="code",description="状态码")
