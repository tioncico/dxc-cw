 ...
 * @ApiGroup(groupName="/Api/Admin.Pet")
 * @ApiGroupAuth(name="")
 * @ApiGroupDescription("")
 */
class Pet extends AdminBase
{
	/**
	 * @Api(name="add",path="/Api/Admin/Pet/add")
	 * @ApiDescription("新增数据")
	...
	/**
	 * @Api(name="update",path="/Api/Admin/Pet/update")
	 * @ApiDescription("更新数据")
	 * @Method(allow={GET,POST})
	 * @InjectParamsContext(key="param")
	 * @ApiSuccessParam(name="code",description="状态码")
	...
	public function update()
	{
		$param = ContextManager::getInstance()->get('param');
		$model = new PetModel();
		$info = $model->get(['petId' => $param['petId']]);
		if (empty($info)) {
	...
	/**
	 * @Api(name="getOne",path="/Api/Admin/Pet/getOne")
	...
	/**
	 * @Api(name="getList",path="/Api/Admin/Pet/getList")
	...
	/**
	 * @Api(name="delete",path="/Api/Admin/Pet/delete")
	 * @ApiDescription("删除数据")
	 * @Method(allow={GET,POST})
	 * @InjectParamsContext(key="param")
	 * @ApiSuccessParam(name="code",description="状态码")
