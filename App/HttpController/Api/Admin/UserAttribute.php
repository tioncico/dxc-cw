 ...
 * @ApiGroup(groupName="/Api/Admin.UserAttribute")
 * @ApiGroupAuth(name="")
 * @ApiGroupDescription("")
 */
class UserAttribute extends AdminBase
{
	/**
	 * @Api(name="add",path="/Api/Admin/UserAttribute/add")
	 * @ApiDescription("新增数据")
	 ...
	 * @Param(name="level",alias="等级",description="等级",lengthMax="11",required="")
	 * @Param(name="exp",alias="经验",description="经验",lengthMax="11",required="")
	 * @Param(name="hp",alias="血量",description="血量",lengthMax="11",required="")
	 * @Param(name="mp",alias="法力值",description="法力值",lengthMax="11",required="")
     ...
     * @Param(name="penetrate",alias="穿透",description="穿透",lengthMax="11",required="")
	 ...
	 * @Param(name="luck",alias="幸运值",description="幸运值",lengthMax="11",required="")
	 * @Param(name="physicalStrength",alias="体力",description="体力",lengthMax="11",required="")
	 */
	public function add()
	{
	...
	/**
	 * @Api(name="update",path="/Api/Admin/UserAttribute/update")
	 * @ApiDescription("更新数据")
	 * @Method(allow={GET,POST})
	 * @InjectParamsContext(key="param")
	 * @ApiSuccessParam(name="code",description="状态码")
	 ...
	 * @Param(name="userId",lengthMax="11",required="")
	 * @Param(name="level",alias="等级",description="等级",lengthMax="11",optional="")
	 * @Param(name="exp",alias="经验",description="经验",lengthMax="11",optional="")
	...
	/**
	 * @Api(name="getOne",path="/Api/Admin/UserAttribute/getOne")
	...
	/**
	 * @Api(name="getList",path="/Api/Admin/UserAttribute/getList")
	...
	/**
	 * @Api(name="delete",path="/Api/Admin/UserAttribute/delete")
	 * @ApiDescription("删除数据")
	 * @Method(allow={GET,POST})
	 * @InjectParamsContext(key="param")
	 * @ApiSuccessParam(name="code",description="状态码")
