 ...
 * @ApiGroup(groupName="/Api/Admin.UserBuyShopGoodsOrder")
 * @ApiGroupAuth(name="")
 * @ApiGroupDescription("")
 */
class UserBuyShopGoodsOrder extends AdminBase
{
	/**
	 * @Api(name="add",path="/Api/Admin/UserBuyShopGoodsOrder/add")
	 * @ApiDescription("新增数据")
	...
	/**
	 * @Api(name="update",path="/Api/Admin/UserBuyShopGoodsOrder/update")
	 * @ApiDescription("更新数据")
	 * @Method(allow={GET,POST})
	 * @InjectParamsContext(key="param")
	 * @ApiSuccessParam(name="code",description="状态码")
	...
	/**
	 * @Api(name="getOne",path="/Api/Admin/UserBuyShopGoodsOrder/getOne")
	...
	/**
	 * @Api(name="getList",path="/Api/Admin/UserBuyShopGoodsOrder/getList")
	...
	/**
	 * @Api(name="delete",path="/Api/Admin/UserBuyShopGoodsOrder/delete")
	 * @ApiDescription("删除数据")
	 * @Method(allow={GET,POST})
	 * @InjectParamsContext(key="param")
	 * @ApiSuccessParam(name="code",description="状态码")
