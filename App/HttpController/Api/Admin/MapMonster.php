 ...
 * @ApiGroup(groupName="/Api/Admin.MapMonster")
 * @ApiGroupAuth(name="")
 * @ApiGroupDescription("")
 */
class MapMonster extends AdminBase
{
	/**
	 * @Api(name="add",path="/Api/Admin/MapMonster/add")
	 * @ApiDescription("新增数据")
	...
	/**
	 * @Api(name="update",path="/Api/Admin/MapMonster/update")
	 * @ApiDescription("更新数据")
	 * @Method(allow={GET,POST})
	 * @InjectParamsContext(key="param")
	 * @ApiSuccessParam(name="code",description="状态码")
	...
	public function update()
	{
		...
		$info = $model->get(['mapMonsterId' => $param['mapMonsterId']]);
		if (empty($info)) {
	...
	/**
	 * @Api(name="getOne",path="/Api/Admin/MapMonster/getOne")
	...
	/**
	 * @Api(name="getList",path="/Api/Admin/MapMonster/getList")
	...
	/**
	 * @Api(name="delete",path="/Api/Admin/MapMonster/delete")
	 * @ApiDescription("删除数据")
	 * @Method(allow={GET,POST})
	 * @InjectParamsContext(key="param")
	 * @ApiSuccessParam(name="code",description="状态码")
