 ...
 * @ApiGroup(groupName="/Api/Admin.UserEquipmentBackpack")
 * @ApiGroupAuth(name="")
 * @ApiGroupDescription("")
 */
class UserEquipmentBackpack extends AdminBase
{
	/**
	 * @Api(name="add",path="/Api/Admin/UserEquipmentBackpack/add")
	 * @ApiDescription("新增数据")
	...
	/**
	 * @Api(name="update",path="/Api/Admin/UserEquipmentBackpack/update")
	 * @ApiDescription("更新数据")
	 * @Method(allow={GET,POST})
	 * @InjectParamsContext(key="param")
	 * @ApiSuccessParam(name="code",description="状态码")
	...
	/**
	 * @Api(name="getOne",path="/Api/Admin/UserEquipmentBackpack/getOne")
	...
	/**
	 * @Api(name="getList",path="/Api/Admin/UserEquipmentBackpack/getList")
	...
	/**
	 * @Api(name="delete",path="/Api/Admin/UserEquipmentBackpack/delete")
	 * @ApiDescription("删除数据")
	 * @Method(allow={GET,POST})
	 * @InjectParamsContext(key="param")
	 * @ApiSuccessParam(name="code",description="状态码")
