 ...
 * @ApiGroup(groupName="/Api/User.UserSign")
 * @ApiGroupAuth(name="")
 * @ApiGroupDescription("")
 */
class UserSign extends UserBase
{
	/**
	 * @Api(name="add",path="/Api/User/UserSign/add")
	 * @ApiDescription("新增数据")
	...
	/**
	 * @Api(name="update",path="/Api/User/UserSign/update")
	 * @ApiDescription("更新数据")
	 * @Method(allow={GET,POST})
	 * @InjectParamsContext(key="param")
	 * @ApiSuccessParam(name="code",description="状态码")
	...
	/**
	 * @Api(name="getOne",path="/Api/User/UserSign/getOne")
	...
	/**
	 * @Api(name="getList",path="/Api/User/UserSign/getList")
	...
	/**
	 * @Api(name="delete",path="/Api/User/UserSign/delete")
	 * @ApiDescription("删除数据")
	 * @Method(allow={GET,POST})
	 * @InjectParamsContext(key="param")
	 * @ApiSuccessParam(name="code",description="状态码")
