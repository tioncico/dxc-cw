 ...
 * @ApiGroup(groupName="/Api/User.MapMonster")
 * @ApiGroupAuth(name="")
 * @ApiGroupDescription("")
 */
class MapMonster extends UserBase
{
	/**
	 * @Api(name="add",path="/Api/User/MapMonster/add")
	 * @ApiDescription("新增数据")
	...
	/**
	 * @Api(name="update",path="/Api/User/MapMonster/update")
	 * @ApiDescription("更新数据")
	 * @Method(allow={GET,POST})
	 * @InjectParamsContext(key="param")
	 * @ApiSuccessParam(name="code",description="状态码")
	...
	/**
	 * @Api(name="getOne",path="/Api/User/MapMonster/getOne")
	...
	/**
	 * @Api(name="getList",path="/Api/User/MapMonster/getList")
	...
	/**
	 * @Api(name="delete",path="/Api/User/MapMonster/delete")
	 * @ApiDescription("删除数据")
	 * @Method(allow={GET,POST})
	 * @InjectParamsContext(key="param")
	 * @ApiSuccessParam(name="code",description="状态码")
