 ...
 * @ApiGroup(groupName="/Api/User.GoodsEquipmentAttributeEntry")
 * @ApiGroupAuth(name="")
 * @ApiGroupDescription("")
 */
class GoodsEquipmentAttributeEntry extends UserBase
{
	/**
	 * @Api(name="add",path="/Api/User/GoodsEquipmentAttributeEntry/add")
	 * @ApiDescription("新增数据")
	...
	/**
	 * @Api(name="update",path="/Api/User/GoodsEquipmentAttributeEntry/update")
	 * @ApiDescription("更新数据")
	 * @Method(allow={GET,POST})
	 * @InjectParamsContext(key="param")
	 * @ApiSuccessParam(name="code",description="状态码")
	...
	/**
	 * @Api(name="getOne",path="/Api/User/GoodsEquipmentAttributeEntry/getOne")
	...
	/**
	 * @Api(name="getList",path="/Api/User/GoodsEquipmentAttributeEntry/getList")
	...
	/**
	 * @Api(name="delete",path="/Api/User/GoodsEquipmentAttributeEntry/delete")
	 * @ApiDescription("删除数据")
	 * @Method(allow={GET,POST})
	 * @InjectParamsContext(key="param")
	 * @ApiSuccessParam(name="code",description="状态码")
