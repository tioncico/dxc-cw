 ...
 * @ApiGroup(groupName="/Api/User.MapGoods")
 * @ApiGroupAuth(name="")
 * @ApiGroupDescription("")
 */
class MapGoods extends UserBase
{
	/**
	 * @Api(name="add",path="/Api/User/MapGoods/add")
	 * @ApiDescription("新增数据")
	...
	/**
	 * @Api(name="update",path="/Api/User/MapGoods/update")
	 * @ApiDescription("更新数据")
	 * @Method(allow={GET,POST})
	 * @InjectParamsContext(key="param")
	 * @ApiSuccessParam(name="code",description="状态码")
	...
	/**
	 * @Api(name="getOne",path="/Api/User/MapGoods/getOne")
	...
	/**
	 * @Api(name="getList",path="/Api/User/MapGoods/getList")
	...
	/**
	 * @Api(name="delete",path="/Api/User/MapGoods/delete")
	 * @ApiDescription("删除数据")
	 * @Method(allow={GET,POST})
	 * @InjectParamsContext(key="param")
	 * @ApiSuccessParam(name="code",description="状态码")
