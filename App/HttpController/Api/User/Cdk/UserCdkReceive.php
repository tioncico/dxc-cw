 ...
 * @ApiGroup(groupName="/Api/User/Cdk.UserCdkReceive")
 * @ApiGroupAuth(name="")
 * @ApiGroupDescription("")
 */
class UserCdkReceive extends UserBase
{
	/**
	 * @Api(name="add",path="/Api/User/Cdk/UserCdkReceive/add")
	 * @ApiDescription("新增数据")
	...
	/**
	 * @Api(name="update",path="/Api/User/Cdk/UserCdkReceive/update")
	 * @ApiDescription("更新数据")
	 * @Method(allow={GET,POST})
	 * @InjectParamsContext(key="param")
	 * @ApiSuccessParam(name="code",description="状态码")
	...
	/**
	 * @Api(name="getOne",path="/Api/User/Cdk/UserCdkReceive/getOne")
	...
	/**
	 * @Api(name="getList",path="/Api/User/Cdk/UserCdkReceive/getList")
	...
	/**
	 * @Api(name="delete",path="/Api/User/Cdk/UserCdkReceive/delete")
	 * @ApiDescription("删除数据")
	 * @Method(allow={GET,POST})
	 * @InjectParamsContext(key="param")
	 * @ApiSuccessParam(name="code",description="状态码")
