 ...
 * @ApiGroup(groupName="/Api/User/Cdk.GameCdkGoods")
 * @ApiGroupAuth(name="")
 * @ApiGroupDescription("")
 */
class GameCdkGoods extends UserBase
{
	/**
	 * @Api(name="add",path="/Api/User/Cdk/GameCdkGoods/add")
	 * @ApiDescription("新增数据")
	...
	/**
	 * @Api(name="update",path="/Api/User/Cdk/GameCdkGoods/update")
	 * @ApiDescription("更新数据")
	 * @Method(allow={GET,POST})
	 * @InjectParamsContext(key="param")
	 * @ApiSuccessParam(name="code",description="状态码")
	...
	/**
	 * @Api(name="getOne",path="/Api/User/Cdk/GameCdkGoods/getOne")
	...
	/**
	 * @Api(name="getList",path="/Api/User/Cdk/GameCdkGoods/getList")
	...
	/**
	 * @Api(name="delete",path="/Api/User/Cdk/GameCdkGoods/delete")
	 * @ApiDescription("删除数据")
	 * @Method(allow={GET,POST})
	 * @InjectParamsContext(key="param")
	 * @ApiSuccessParam(name="code",description="状态码")
