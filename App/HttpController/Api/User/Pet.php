 ...
 * @ApiGroupDescription("")
 */
class Pet extends UserBase
{
	/**
	 * @Api(name="add",path="/Api/User/Pet/add")
	 * @ApiDescription("新增数据")
	...
	/**
	 * @Api(name="update",path="/Api/User/Pet/update")
	 * @ApiDescription("更新数据")
	 * @Method(allow={GET,POST})
	 * @InjectParamsContext(key="param")
	 * @ApiSuccessParam(name="code",description="状态码")
	...
	/**
	 * @Api(name="getOne",path="/Api/User/Pet/getOne")
	...
	/**
	 * @Api(name="getList",path="/Api/User/Pet/getList")
	...
	/**
	 * @Api(name="delete",path="/Api/User/Pet/delete")
	 * @ApiDescription("删除数据")
	 * @Method(allow={GET,POST})
	 * @InjectParamsContext(key="param")
	 * @ApiSuccessParam(name="code",description="状态码")
