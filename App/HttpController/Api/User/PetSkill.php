 ...
 * @ApiGroup(groupName="/Api/User.PetSkill")
 * @ApiGroupAuth(name="")
 * @ApiGroupDescription("")
 */
class PetSkill extends UserBase
{
	/**
	 * @Api(name="add",path="/Api/User/PetSkill/add")
	 * @ApiDescription("新增数据")
	...
	/**
	 * @Api(name="update",path="/Api/User/PetSkill/update")
	 * @ApiDescription("更新数据")
	 * @Method(allow={GET,POST})
	 * @InjectParamsContext(key="param")
	 * @ApiSuccessParam(name="code",description="状态码")
	...
	/**
	 * @Api(name="getOne",path="/Api/User/PetSkill/getOne")
	...
	/**
	 * @Api(name="getList",path="/Api/User/PetSkill/getList")
	...
	/**
	 * @Api(name="delete",path="/Api/User/PetSkill/delete")
	 * @ApiDescription("删除数据")
	 * @Method(allow={GET,POST})
	 * @InjectParamsContext(key="param")
	 * @ApiSuccessParam(name="code",description="状态码")
