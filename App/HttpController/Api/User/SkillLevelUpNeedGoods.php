 ...
 * @ApiGroup(groupName="/Api/User.SkillLevelUpNeedGoods")
 * @ApiGroupAuth(name="")
 * @ApiGroupDescription("")
 */
class SkillLevelUpNeedGoods extends UserBase
{
	/**
	 * @Api(name="add",path="/Api/User/SkillLevelUpNeedGoods/add")
	 * @ApiDescription("新增数据")
	...
	/**
	 * @Api(name="update",path="/Api/User/SkillLevelUpNeedGoods/update")
	 * @ApiDescription("更新数据")
	 * @Method(allow={GET,POST})
	 * @InjectParamsContext(key="param")
	 * @ApiSuccessParam(name="code",description="状态码")
	...
	/**
	 * @Api(name="getOne",path="/Api/User/SkillLevelUpNeedGoods/getOne")
	...
	/**
	 * @Api(name="getList",path="/Api/User/SkillLevelUpNeedGoods/getList")
	...
	/**
	 * @Api(name="delete",path="/Api/User/SkillLevelUpNeedGoods/delete")
	 * @ApiDescription("删除数据")
	 * @Method(allow={GET,POST})
	 * @InjectParamsContext(key="param")
	 * @ApiSuccessParam(name="code",description="状态码")
