 ...
 * @ApiGroup(groupName="/Api/User.SignReward")
 * @ApiGroupAuth(name="")
 * @ApiGroupDescription("")
 */
class SignReward extends UserBase
{
	/**
	 * @Api(name="add",path="/Api/User/SignReward/add")
	 * @ApiDescription("新增数据")
	...
	/**
	 * @Api(name="update",path="/Api/User/SignReward/update")
	 * @ApiDescription("更新数据")
	 * @Method(allow={GET,POST})
	 * @InjectParamsContext(key="param")
	 * @ApiSuccessParam(name="code",description="状态码")
	...
	/**
	 * @Api(name="getOne",path="/Api/User/SignReward/getOne")
	...
	/**
	 * @Api(name="getList",path="/Api/User/SignReward/getList")
	...
	/**
	 * @Api(name="delete",path="/Api/User/SignReward/delete")
	 * @ApiDescription("删除数据")
	 * @Method(allow={GET,POST})
	 * @InjectParamsContext(key="param")
	 * @ApiSuccessParam(name="code",description="状态码")
