 ...
 * @ApiGroup(groupName="/Api/User.UserPetSkill")
 * @ApiGroupAuth(name="")
 * @ApiGroupDescription("")
 */
class UserPetSkill extends UserBase
{
	/**
	 * @Api(name="add",path="/Api/User/UserPetSkill/add")
	 * @ApiDescription("新增数据")
	...
	/**
	 * @Api(name="update",path="/Api/User/UserPetSkill/update")
	 * @ApiDescription("更新数据")
	 * @Method(allow={GET,POST})
	 * @InjectParamsContext(key="param")
	 * @ApiSuccessParam(name="code",description="状态码")
	...
	/**
	 * @Api(name="getOne",path="/Api/User/UserPetSkill/getOne")
	...
	/**
	 * @Api(name="getList",path="/Api/User/UserPetSkill/getList")
	...
	/**
	 * @Api(name="delete",path="/Api/User/UserPetSkill/delete")
	 * @ApiDescription("删除数据")
	 * @Method(allow={GET,POST})
	 * @InjectParamsContext(key="param")
	 * @ApiSuccessParam(name="code",description="状态码")
