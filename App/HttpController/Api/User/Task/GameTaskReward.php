 ...
 * @ApiGroup(groupName="/Api/User/Task.GameTaskReward")
 * @ApiGroupAuth(name="")
 * @ApiGroupDescription("")
 */
class GameTaskReward extends UserBase
{
	/**
	 * @Api(name="add",path="/Api/User/Task/GameTaskReward/add")
	 * @ApiDescription("新增数据")
	...
	/**
	 * @Api(name="update",path="/Api/User/Task/GameTaskReward/update")
	 * @ApiDescription("更新数据")
	 * @Method(allow={GET,POST})
	 * @InjectParamsContext(key="param")
	 * @ApiSuccessParam(name="code",description="状态码")
	...
	/**
	 * @Api(name="getOne",path="/Api/User/Task/GameTaskReward/getOne")
	...
	/**
	 * @Api(name="getList",path="/Api/User/Task/GameTaskReward/getList")
	...
	/**
	 * @Api(name="delete",path="/Api/User/Task/GameTaskReward/delete")
	 * @ApiDescription("删除数据")
	 * @Method(allow={GET,POST})
	 * @InjectParamsContext(key="param")
	 * @ApiSuccessParam(name="code",description="状态码")
