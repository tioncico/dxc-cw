 ...
 * @ApiGroup(groupName="/Api/User/Task.UserGameTaskMasterComplete")
 * @ApiGroupAuth(name="")
 * @ApiGroupDescription("")
 */
class UserGameTaskMasterComplete extends UserBase
{
	/**
	 * @Api(name="add",path="/Api/User/Task/UserGameTaskMasterComplete/add")
	 * @ApiDescription("新增数据")
	...
	/**
	 * @Api(name="update",path="/Api/User/Task/UserGameTaskMasterComplete/update")
	 * @ApiDescription("更新数据")
	 * @Method(allow={GET,POST})
	 * @InjectParamsContext(key="param")
	 * @ApiSuccessParam(name="code",description="状态码")
	...
	/**
	 * @Api(name="getOne",path="/Api/User/Task/UserGameTaskMasterComplete/getOne")
	...
	/**
	 * @Api(name="getList",path="/Api/User/Task/UserGameTaskMasterComplete/getList")
	...
	/**
	 * @Api(name="delete",path="/Api/User/Task/UserGameTaskMasterComplete/delete")
	 * @ApiDescription("删除数据")
	 * @Method(allow={GET,POST})
	 * @InjectParamsContext(key="param")
	 * @ApiSuccessParam(name="code",description="状态码")
