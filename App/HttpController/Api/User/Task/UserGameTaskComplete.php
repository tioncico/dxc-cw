 ...
 * @ApiGroup(groupName="/Api/User/Task.UserGameTaskComplete")
 * @ApiGroupAuth(name="")
 * @ApiGroupDescription("")
 */
class UserGameTaskComplete extends UserBase
{
	/**
	 * @Api(name="add",path="/Api/User/Task/UserGameTaskComplete/add")
	 * @ApiDescription("新增数据")
	...
	/**
	 * @Api(name="update",path="/Api/User/Task/UserGameTaskComplete/update")
	 * @ApiDescription("更新数据")
	 * @Method(allow={GET,POST})
	 * @InjectParamsContext(key="param")
	 * @ApiSuccessParam(name="code",description="状态码")
	...
	/**
	 * @Api(name="getOne",path="/Api/User/Task/UserGameTaskComplete/getOne")
	...
	/**
	 * @Api(name="getList",path="/Api/User/Task/UserGameTaskComplete/getList")
	...
	/**
	 * @Api(name="delete",path="/Api/User/Task/UserGameTaskComplete/delete")
	 * @ApiDescription("删除数据")
	 * @Method(allow={GET,POST})
	 * @InjectParamsContext(key="param")
	 * @ApiSuccessParam(name="code",description="状态码")
