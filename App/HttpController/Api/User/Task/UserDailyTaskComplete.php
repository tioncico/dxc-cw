 ...
 * @ApiGroup(groupName="/Api/User/Task.UserDailyTaskComplete")
 * @ApiGroupAuth(name="")
 * @ApiGroupDescription("")
 */
class UserDailyTaskComplete extends UserBase
{
	/**
	 * @Api(name="add",path="/Api/User/Task/UserDailyTaskComplete/add")
	 * @ApiDescription("新增数据")
	...
	/**
	 * @Api(name="update",path="/Api/User/Task/UserDailyTaskComplete/update")
	 * @ApiDescription("更新数据")
	 * @Method(allow={GET,POST})
	 * @InjectParamsContext(key="param")
	 * @ApiSuccessParam(name="code",description="状态码")
	...
	/**
	 * @Api(name="getOne",path="/Api/User/Task/UserDailyTaskComplete/getOne")
	...
	/**
	 * @Api(name="getList",path="/Api/User/Task/UserDailyTaskComplete/getList")
	...
	/**
	 * @Api(name="delete",path="/Api/User/Task/UserDailyTaskComplete/delete")
	 * @ApiDescription("删除数据")
	 * @Method(allow={GET,POST})
	 * @InjectParamsContext(key="param")
	 * @ApiSuccessParam(name="code",description="状态码")
