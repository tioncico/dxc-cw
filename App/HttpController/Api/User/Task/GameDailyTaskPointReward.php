 ...
 * @ApiGroup(groupName="/Api/User/Task.GameDailyTaskPointReward")
 * @ApiGroupAuth(name="")
 * @ApiGroupDescription("")
 */
class GameDailyTaskPointReward extends UserBase
{
	/**
	 * @Api(name="add",path="/Api/User/Task/GameDailyTaskPointReward/add")
	 * @ApiDescription("新增数据")
	...
	/**
	 * @Api(name="update",path="/Api/User/Task/GameDailyTaskPointReward/update")
	 * @ApiDescription("更新数据")
	 * @Method(allow={GET,POST})
	 * @InjectParamsContext(key="param")
	 * @ApiSuccessParam(name="code",description="状态码")
	...
	/**
	 * @Api(name="getOne",path="/Api/User/Task/GameDailyTaskPointReward/getOne")
	...
	/**
	 * @Api(name="getList",path="/Api/User/Task/GameDailyTaskPointReward/getList")
	...
	/**
	 * @Api(name="delete",path="/Api/User/Task/GameDailyTaskPointReward/delete")
	 * @ApiDescription("删除数据")
	 * @Method(allow={GET,POST})
	 * @InjectParamsContext(key="param")
	 * @ApiSuccessParam(name="code",description="状态码")
