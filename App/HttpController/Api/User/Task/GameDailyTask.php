 ...
 * @ApiGroup(groupName="/Api/User/Task.GameDailyTask")
 * @ApiGroupAuth(name="")
 * @ApiGroupDescription("")
 */
class GameDailyTask extends UserBase
{
	/**
	 * @Api(name="add",path="/Api/User/Task/GameDailyTask/add")
	 * @ApiDescription("新增数据")
	...
	/**
	 * @Api(name="update",path="/Api/User/Task/GameDailyTask/update")
	 * @ApiDescription("更新数据")
	 * @Method(allow={GET,POST})
	 * @InjectParamsContext(key="param")
	 * @ApiSuccessParam(name="code",description="状态码")
	...
	/**
	 * @Api(name="getOne",path="/Api/User/Task/GameDailyTask/getOne")
	...
	/**
	 * @Api(name="getList",path="/Api/User/Task/GameDailyTask/getList")
	...
	/**
	 * @Api(name="delete",path="/Api/User/Task/GameDailyTask/delete")
	 * @ApiDescription("删除数据")
	 * @Method(allow={GET,POST})
	 * @InjectParamsContext(key="param")
	 * @ApiSuccessParam(name="code",description="状态码")
