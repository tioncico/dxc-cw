 ...
 * @ApiGroup(groupName="/Api/User.GoodsEquipment")
 * @ApiGroupAuth(name="")
 * @ApiGroupDescription("")
 */
class GoodsEquipment extends UserBase
{
	/**
	 * @Api(name="add",path="/Api/User/GoodsEquipment/add")
	 * @ApiDescription("新增数据")
	...
	/**
	 * @Api(name="update",path="/Api/User/GoodsEquipment/update")
	 * @ApiDescription("更新数据")
	 * @Method(allow={GET,POST})
	 * @InjectParamsContext(key="param")
	 * @ApiSuccessParam(name="code",description="状态码")
	...
	/**
	 * @Api(name="getOne",path="/Api/User/GoodsEquipment/getOne")
	...
	/**
	 * @Api(name="getList",path="/Api/User/GoodsEquipment/getList")
	...
	/**
	 * @Api(name="delete",path="/Api/User/GoodsEquipment/delete")
	 * @ApiDescription("删除数据")
	 * @Method(allow={GET,POST})
	 * @InjectParamsContext(key="param")
	 * @ApiSuccessParam(name="code",description="状态码")
