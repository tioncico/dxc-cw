...
class UserPet extends UserBase
{
    ...
    /**
     * @Api(name="宠物使用物品",path="/Api/User/UserPet/petUseGoods")
     * @ApiDescription("宠物使用物品")
     * @Method(allow={GET,POST})
     * @InjectParamsContext(key="param")
     * @ApiSuccessParam(name="code",description="状态码")
     * @ApiSuccessParam(name="result",description="api请求结果")
     ...
     * @ApiSuccessParam(name="result[].light",description="光")
     * @ApiSuccessParam(name="result[].dark",description="暗")
     * @ApiSuccessParam(name="result[].skillList[].userPetSkillId",description="玩家技能id")
     * @ApiSuccessParam(name="result[].skillList[].userId",description="玩家id")
     * @ApiSuccessParam(name="result[].skillList[].userPetId",description="玩家宠物id")
     * @ApiSuccessParam(name="result[].skillList[].skillId",description="技能id")
     * @ApiSuccessParam(name="result[].skillList[].skillName",description="技能名")
     * @ApiSuccessParam(name="result[].skillList[].triggerType",description=" 触发类型 0主动触发 1战斗前buff,2攻击前触发,3攻击后触发,4被攻击前触发,5被攻击后触发,6扣血触发,7一秒触发一次,8战斗结束前触发,9战斗结束后触发")
     * @ApiSuccessParam(name="result[].skillList[].triggerRate",description="触发概率计算")
     * @ApiSuccessParam(name="result[].skillList[].isUse",description="是否穿戴")
     * @ApiSuccessParam(name="result[].skillList[].level",description="技能等级")
     * @ApiSuccessParam(name="result[].skillList[].rarityLevel",description="稀有度 1普通,2精致,3稀有,4罕见,5传说,6神话,7噩梦神话")
     * @ApiSuccessParam(name="result[].skillList[].maxLevel",description="最大等级")
     * @ApiSuccessParam(name="result[].skillList[].coolingTime",description="冷却时间")
     * @ApiSuccessParam(name="result[].skillList[].manaCost",description="耗蓝")
     * @ApiSuccessParam(name="result[].skillList[].entryCode",description="词条code")
     * @ApiSuccessParam(name="result[].skillList[].description",description="介绍")
     * @ApiSuccessParam(name="result[].skillList[].effectParam",description="参数")
     */
