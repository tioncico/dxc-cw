 ...
 * @ApiGroup(groupName="/Api/User.Buff")
 * @ApiGroupAuth(name="")
 * @ApiGroupDescription("")
 */
class Buff extends UserBase
{
	/**
	 * @Api(name="add",path="/Api/User/Buff/add")
	 * @ApiDescription("新增数据")
	...
	/**
	 * @Api(name="update",path="/Api/User/Buff/update")
	 * @ApiDescription("更新数据")
	 * @Method(allow={GET,POST})
	 * @InjectParamsContext(key="param")
	 * @ApiSuccessParam(name="code",description="状态码")
	...
	/**
	 * @Api(name="getOne",path="/Api/User/Buff/getOne")
	...
	/**
	 * @Api(name="getList",path="/Api/User/Buff/getList")
	...
	/**
	 * @Api(name="delete",path="/Api/User/Buff/delete")
	 * @ApiDescription("删除数据")
	 * @Method(allow={GET,POST})
	 * @InjectParamsContext(key="param")
	 * @ApiSuccessParam(name="code",description="状态码")
